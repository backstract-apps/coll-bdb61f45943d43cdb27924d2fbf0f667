...
app = FastAPI(title='Backstract Generated APIs - coll-bdb61f45943d43cdb27924d2fbf0f667', debug=False,
              docs_url='/silly-agnesi-a309fa7ef7ff11ef8ff20242ac12000582/docs',
              openapi_url='/silly-agnesi-a309fa7ef7ff11ef8ff20242ac12000582/openapi.json')
...
app.include_router(
    router,
    prefix='/silly-agnesi-a309fa7ef7ff11ef8ff20242ac12000582/api',
    tags=['APIs v1']
)
